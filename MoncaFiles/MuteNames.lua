...
if DevAbs:get(Monca.."Abs:Lock:MuteNames"..msg.chat_id_) then
if Manager(msg) then
...
DevAbs:sadd(Monca.."Abs:Mute:Names"..msg.chat_id_, MuteName)
end
...
DevAbs:srem(Monca.."Abs:Mute:Names"..msg.chat_id_, UnMuteName)
end
end
if text == "مسح الاسماء المكتومه" and Constructor(msg) then
DevAbs:del(Monca.."Abs:Mute:Names"..msg.chat_id_)
send(msg.chat_id_, msg.id_, "⌁︙تم مسح الاسماء المكتومه")
end
if text == "الاسماء المكتومه" and Constructor(msg) then
local AllNames = DevAbs:smembers(Monca.."Abs:Mute:Names"..msg.chat_id_)
...
if not Manager(msg) and DevAbs:get(Monca.."Abs:Lock:MuteNames"..msg.chat_id_) then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
if result.id_ then 
MoncaName = ((result.first_name_ or "") .. (result.last_name_ or ""))
if MoncaName then 
MoncaNames = DevAbs:smembers(Monca.."Abs:Mute:Names"..msg.chat_id_) or ""
if MoncaNames and MoncaNames[1] then 
for i=1,#MoncaNames do 
if MoncaName:match("(.*)("..MoncaNames[i]..")(.*)") then 
...
DevAbs:set(Monca.."Abs:Lock:MuteNames"..msg.chat_id_,true)
end
...
DevAbs:del(Monca.."Abs:Lock:MuteNames"..msg.chat_id_)
end
end
end
